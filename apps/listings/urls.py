...
from apps.listings.views.listing_list import (
    ListingPublicListView,
    ListingMyListView,
)
...
urlpatterns = [
    ...
    path(
        "",
        ListingPublicListView.as_view(),
        name="listing-public-list",
    ),
    ...
    path(
        "my/",
        ListingMyListView.as_view(),
        name="listing-my-list",
    ),

    # SEARCH ANALYTICS
    path(
        "search/popular/",
        PopularSearchQueryView.as_view(),
